...
class PasswordGenerator:
    def __init__(self, length=8, include_uppercase=True, include_lowercase=True, include_digits=True,
        ...
        """
        Block below Initializes the PasswordGenerator class with the specified attributes.
...
def prompt_user_input():
    """
    Here we are proposing to  the user to enter the desired password length and criteria.
